...
from modules.trainer import Trainer, Trainer_DPO
...
def parse_agrs():
    ...
    parser.add_argument('--lr_ed', type=float, default=1e-6, help='the learning rate for the remaining parameters.')
...
def main():
    ...
    #trainer._resume_checkpoint("/apdcephfs_cq10/share_1290796/lh/RG2D/R2Gen-main/results/mimic_cxr/model_best.pth")
    #trainer.test(0)
